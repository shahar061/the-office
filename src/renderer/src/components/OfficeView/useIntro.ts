...
export function useCeoIntroSteps(): DialogueStep[] {
  const t = useT();
  return useMemo<DialogueStep[]>(
    () => [
      { text: t('intro.ceo.step1'), highlights: [] },
      { text: t('intro.ceo.step2'), highlights: ['imagine'] },
      { text: t('intro.ceo.step3'), highlights: ['imagine', 'warroom', 'build'] },
      { text: t('intro.ceo.step4'), highlights: [], highlightChat: true },
      { text: t('intro.ceo.step5'), highlights: [] },
    ],
    [t],
  );
}
