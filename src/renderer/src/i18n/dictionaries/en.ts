export const en = {
  ...
  'settings.appearance.theme.light.description': 'Bright daytime palette with high-contrast text. The canvas stays as-is.',
  'settings.appearance.theme.neon': 'Neon',
  'settings.appearance.theme.neon.description': 'Saturated magenta + cyan on near-black. Playful, screenshot-ready.',
  'settings.appearance.theme.dusk': 'Dusk',
  'settings.appearance.theme.dusk.description': 'Warm terracotta + amber. Cozy late-evening vibe, low stimulation.',
  'settings.appearance.theme.terminal': 'Terminal',
  'settings.appearance.theme.terminal.description': 'Phosphor green on black. Mission-control mode for deep work.',
  'settings.appearance.preview.message': 'Hi team',
  'settings.appearance.preview.button': 'Run',
  'settings.appearance.preview.task': 'Build feature',
  ...
  'settings.privacy.subtitle': 'Help us make The Office better by sharing anonymous usage data. Off by default — turn it on only if you want to.',
  'settings.privacy.toggle.label': 'Share anonymous usage data',
  'settings.privacy.toggle.description': 'Sends a small set of events (phase started, project created, etc.) and uncaught error reports. Tied to a random ID, not to you.',
  'settings.privacy.collected.title': 'What we collect',
  'settings.privacy.collected.item.events': 'App lifecycle, phase progression, language and theme selections.',
  'settings.privacy.collected.item.errors': 'Uncaught error messages and stack traces, with file paths redacted.',
  'settings.privacy.collected.item.platform': 'OS family (macOS / Windows / Linux) and app version.',
  'settings.privacy.notCollected.title': 'What we never collect',
  'settings.privacy.notCollected.item.code': 'Your code, your prompts, agent output, or anything from your repo.',
  'settings.privacy.notCollected.item.prompts': 'API keys, project names, file names, or paths.',
  'settings.privacy.notCollected.item.identity': 'Your name, email, IP address, or any identifying information.',
  'settings.privacy.installId.label': 'Anonymous ID:',
  'settings.privacy.installId.reset': 'Reset ID',
  'settings.privacy.installId.resetting': 'Resetting…',
  'settings.privacy.installId.resetDone': 'New ID generated.',
  'settings.privacy.delete.title': 'Delete my data',
  'settings.privacy.delete.description': 'Wipe all events and errors associated with your anonymous ID from our servers, and clear the local queue.',
  'settings.privacy.delete.button': 'Delete my data',
  'settings.privacy.delete.deleting': 'Deleting…',
  'settings.privacy.delete.confirm': 'Permanently delete all telemetry data for this install?',
  'settings.privacy.delete.done': 'Data deleted.',
  'settings.privacy.delete.failed': 'Could not reach the server. Try again later.',
  // First-run consent modal
  'consent.title': 'Help improve The Office',
  'consent.body': 'We collect anonymous usage data and crash reports to find bugs and decide what to build next. Off by default — your call.',
  'consent.collected': 'Random install ID, phase events, error stacks. No code, no prompts, no IP.',
  'consent.changeLater': 'You can change this any time in Settings → Privacy.',
  'consent.accept': 'Share anonymous data',
  ...
  // Kanban graph info
  'kanban.graphInfo.title': 'How to read this graph',
  'kanban.graphInfo.section.intro.title': 'What am I looking at?',
  'kanban.graphInfo.section.intro.text': "Each box is a build task. Tasks are grouped into columns by phase and flow left to right. Arrows show dependencies — a task can't start until all tasks pointing to it are done.",
  'kanban.graphInfo.section.status.title': 'Task status (color)',
  'kanban.graphInfo.section.status.text': 'The fill color tells you what state the task is in.',
  'kanban.graphInfo.status.queued.short': 'Waiting to start',
  'kanban.graphInfo.status.queued.full': 'Queued — waiting on dependencies',
  'kanban.graphInfo.status.active.short': 'Running now',
  'kanban.graphInfo.status.active.full': 'Active — agent is working (pulses)',
  'kanban.graphInfo.status.review.short': 'Under review',
  'kanban.graphInfo.status.review.full': 'In Review — self-review step',
  'kanban.graphInfo.status.done.short': 'Finished',
  'kanban.graphInfo.status.done.full': 'Done — completed successfully',
  'kanban.graphInfo.status.failed.short': 'Failed',
  'kanban.graphInfo.status.failed.full': 'Failed — task errored out',
  'kanban.graphInfo.section.badge.title': 'Agent badge (colored dot)',
  'kanban.graphInfo.section.badge.text': 'The small colored dot in the top-left corner identifies which agent owns the task. Each agent role (backend, frontend, etc.) has its own color.',
  'kanban.graphInfo.section.deps.title': 'Dependencies (arrows)',
  'kanban.graphInfo.section.deps.text': 'Arrows go from the task that must finish first (source) to the task that depends on it (target). If A → B, then B cannot start until A is done.',
  'kanban.graphInfo.section.hover.title': 'Hover to trace a chain',
  'kanban.graphInfo.section.hover.text': 'Hover any task to highlight its full dependency chain — every task it depends on (upstream) and every task that depends on it (downstream). Everything else dims. Perfect for answering "why is this task stuck?"',
  'kanban.graphInfo.section.nav.title': 'Navigation',
  'kanban.graphInfo.nav.scroll.kbd': 'scroll',
  'kanban.graphInfo.nav.scroll.text': 'zoom in / out around the cursor',
  'kanban.graphInfo.nav.drag.kbd': 'click + drag',
  'kanban.graphInfo.nav.drag.text': 'pan the view',
  'kanban.graphInfo.nav.fit.kbd': 'Fit to screen',
  'kanban.graphInfo.nav.fit.text': 'recenter and fit everything',
  'kanban.graphInfo.close': 'Close',

  // Workshop panel
  'workshop.composer.newRequest': 'New request',
  'workshop.composer.placeholder': "Describe what you want — e.g., 'add a dark mode toggle to the settings page'",
  'workshop.composer.submit': 'Submit',
  'workshop.composer.notScanned': '⚠️ Project not scanned — agent routing may be less accurate.',
  'workshop.composer.scanNow': 'Scan now',
  'workshop.composer.skipScan': 'Skip scan',
  'workshop.composer.scanning': 'Scanning your project — this takes about 30 seconds. Watch the Chief Architect at work on the map!',
  'workshop.composer.inProgress': 'Request in progress — wait for it to finish',
  'workshop.composer.errorDefault': 'Failed to create request',
  'workshop.list.empty': 'No requests yet — type one above to get started.',
  'workshop.git.label': 'Git identity:',
  'workshop.git.notConfigured': 'not configured',
  'workshop.git.setup': 'Set up',
  'workshop.git.change': 'Change',
  'workshop.git.firstRun.message': 'Commits will be authored as {label} ({email}), your global default.',
  'workshop.git.useDefault': 'Use default',
  'workshop.git.dismiss': 'Dismiss',
